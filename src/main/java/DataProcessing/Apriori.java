...
/** The class encapsulates an implementation of the DataProcessing.Apriori algorithm
 ...
 *   $ java mining.DataProcessing.Apriori fileName support
 *   $ java mining.DataProcessing.Apriori /tmp/data.dat 0.8
 *   $ java mining.DataProcessing.Apriori /tmp/data.dat 0.8 > frequent-itemsets.txt
 *
 *
...
public class Apriori extends Observable {
    ...
    /** by default, DataProcessing.Apriori is used with the command line interface */
